...
class OllamaPlugin(Plugin, LLMProvider):
    ...
    def configure(self, config: dict) -> None:
        ...
        self._host = ollama_config.get("host") or os.environ.get("OLLAMA_HOST", "http://localhost:11434")
    ...
    def start(self) -> None:
        ...
        try:
            ...
            print(f"[Ollama] Connected to {self._host}, {len(models)} models available", file=sys.stderr)
    ...
    def chat(
        ...
        try:
            ...
            raise LLMError(f"Cannot connect to Ollama at {self._host}. Is Ollama running?")
